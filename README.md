...
- **2025.01** – Our follow-up research, **"Spurious Forgetting in Continual Learning of Language Models" (ICLR 2025)**, is now available on [OpenReview](https://openreview.net/forum?id=ScI7IlKGdI)! 🎉 The corresponding code can be accessed in this [repository](https://github.com/zzz47zzz/spurious-forgetting). This work extends the ideas from **"Learn or Recall? Revisiting Incremental Learning with Pre-trained Language Models"** to a more **general continual learning setting**, including *instruction tuning* and *safety alignment* for LLMs.  
- **2024.12** – The interpretation of our paper **"Learn or Recall? Revisiting Incremental Learning with Pre-trained Language Models" (ACL 2024 Oral)** is now featured on [PaperWeekly](https://mp.weixin.qq.com/s/G5oD4UM21PFMNlGz2iwUVw) and [知乎](https://zhuanlan.zhihu.com/p/8972477202)! 📖 Dive into these platforms for an in-depth analysis and discussion.  
